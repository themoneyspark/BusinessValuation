...
const AdminDashboard = () => {
  ...
  return (
    <div className="min-h-screen bg-slate-50">
      {/* Admin Top Bar */}
      <header className="fixed top-0 w-full h-16 bg-slate-900 border-b border-slate-700 z-50">
        <div className="flex items-center justify-between h-full px-4">
          ...
          <div className="hidden md:flex items-center space-x-6 text-sm">
            ...
            <div className="text-slate-300">Users: {mockMetrics.totalUsers} Active</div>
            <div className="text-slate-300">Updated 2 min ago</div>
          </div>
